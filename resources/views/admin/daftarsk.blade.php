        ...
        @section('content')
            ...
            <div class="row">
                <div class="col-lg-12" id="informasi-container">
                            <div class="row" >
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="/surat-keluar/create" class="btn btn-info">Tambah Surat Keluar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <h5 class="card-title fw-semibold card-header">Daftar Surat Keluar</h5>
                                @if($smasuks->isEmpty())
                                        ...
                                        <tr id="row-{{ $masuk->id }}">
                                            ...
                                            <td>
                                                    @role('administrator', 'admin')
                                                        <a href="{{ route('surat-keluar.edit', $masuk->id) }}" 
